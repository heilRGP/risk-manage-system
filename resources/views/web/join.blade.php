        ...
        <div class="container">
            ...
            <div class="col-lg-7 col-lg-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading" style="font-family: 微软雅黑; font-size: medium;">我参与的活动</div>
                    <div class="panel-body">
                        @foreach($activities as $activity)
                            <div class="alert alert-info" style="font-family: 微软雅黑; font-size: medium;">
                                {{ $activity->activitydate }}
                                <br>
                                <a href="#" style="font-family: 微软雅黑; font-size: medium;">@ {{ $activity->creator_name }}</a>
                                <br>
                                {{ $activity->content }}
                                <br>
                                <br>
                                <a href="{{ url("/quit/".$activity->activityID) }}" class="alert-link" style="font-family: 微软雅黑; font-size: small;">退出</a>
                            </div>
                        @endforeach
                    </div>
                </div>
